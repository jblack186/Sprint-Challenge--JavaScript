...
const contactInfo = [];
for (let i = 0; i < graduates.length; i++) {
  var contact = `${graduates[i].first_name} ${graduates[i].email}`
...
*/
let animalNames = [];
var yo = zooAnimals.forEach(function (element) { animalNames.push(`Name: ${element.animal_name}, Scientific: ${element.scientific_name}`)
});
animalNames.push(yo);
...
*/
const populationTotal = zooAnimals.reduce(function (accumulator, value) {
